...
* @returns {Message}
*/
export function parseMessageBase64(message: string): Message;
/**
* @param {string} message
* @returns {JsRawMessage}
*/
export function parseMessageBase64Extended(message: string): JsRawMessage;
/**
...
*/
export function executeLocalExtended(config: string, account: string, message: string, utime: number, disable_signature_check: boolean, overwrite_balance?: string, global_id?: number, trace_logs?: boolean): TransactionExecutorExtendedOutput;
/**
* @param {string} tvc
* @param {string} contract_abi
...
*/
export function decodeRawTransaction(boc: string): JsRawTransaction;
/**
* @param {string} data
* @returns {string}
*/
...
* @returns {bigint}
*/
export function getCapabilitiesFromConfig(config: string): bigint;
...
export interface InitOutput {
  ...
  readonly __wbg_proxyconnection_free: (a: number) => void;
  ...
  readonly parseMessageBase64: (a: number, b: number, c: number) => void;
  readonly parseMessageBase64Extended: (a: number, b: number, c: number) => void;
  ...
  readonly executeLocalExtended: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => void;
  ...
  readonly decodeRawTransaction: (a: number, b: number, c: number) => void;
  ...
  readonly getCapabilitiesFromConfig: (a: number, b: number, c: number) => void;
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__ha40839b4951cc264: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h7ac743469b7fdc26: (a: number, b: number, c: number, d: number) => void;
}
