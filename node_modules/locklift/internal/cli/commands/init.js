...
program
    ...
    const dependencies = "npm i --save-dev typescript@4.7.4 prettier chai @types/chai @types/mocha @types/node everscale-standalone-client ts-mocha locklift dotenv@16.0.3";
